...
#define MASK_HARD_QUAD (1U << 7)
#define MASK_LONG_DOUBLE_128 (1U << 8)
...
#define MASK_DEPRECATED_V8_INSNS (1U << 21)
#define MASK_LEON (1U << 22)
#define MASK_LEON3 (1U << 23)
#define MASK_SPARCLET (1U << 24)
#define MASK_SPARCLITE (1U << 25)
#define MASK_V8 (1U << 26)
#define MASK_V9 (1U << 27)
...
enum opt_code
{
  ...
  OPT_mfix_ut699 = 1160,                     /* -mfix-ut699 */
  OPT_mflat = 1161,                          /* -mflat */
  OPT_mfmaf = 1162,                          /* -mfmaf */
  OPT_mfpu = 1163,                           /* -mfpu */
  OPT_mglibc = 1164,                         /* -mglibc */
  OPT_mhard_float = 1165,                    /* -mhard-float */
  OPT_mhard_quad_float = 1166,               /* -mhard-quad-float */
  OPT_mlong_double_128 = 1167,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1168,                /* -mlong-double-64 */
  OPT_mlra = 1169,                           /* -mlra */
  OPT_mmemory_model_ = 1170,                 /* -mmemory-model= */
  OPT_mmusl = 1171,                          /* -mmusl */
  OPT_mpopc = 1172,                          /* -mpopc */
  OPT_mptr32 = 1173,                         /* -mptr32 */
  OPT_mptr64 = 1174,                         /* -mptr64 */
  OPT_mrelax = 1175,                         /* -mrelax */
  OPT_msoft_float = 1176,                    /* -msoft-float */
  OPT_msoft_quad_float = 1177,               /* -msoft-quad-float */
  OPT_mstack_bias = 1178,                    /* -mstack-bias */
  OPT_mstd_struct_return = 1179,             /* -mstd-struct-return */
  OPT_msubxc = 1180,                         /* -msubxc */
  OPT_mtune_ = 1181,                         /* -mtune= */
  OPT_muclibc = 1182,                        /* -muclibc */
