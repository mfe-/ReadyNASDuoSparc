...
extern
#endif
__inline__ int fstat (int __fd, struct stat *__buf) __THROW;
#else
# ifdef __REDIRECT
#ifdef __GNUC_GNU_INLINE__
extern
#endif
__inline__ int __REDIRECT (stat,
...
extern
#endif
__inline__ int __REDIRECT (fstat, (int __fd, struct stat *__buf) __THROW, fstat64);
# else
#  define stat stat64
...
extern
#endif
__inline__ int __REDIRECT (lstat,
		       (__const char *__restrict __file,
			struct stat *__restrict __buf) __THROW,
		       lstat64);
#  else
...
extern
#endif
__inline__ int stat (__const char *__path,
...
extern
#endif
__inline__ int lstat (__const char *__path,
			     struct stat *__statbuf) __THROW
{
...
extern
#endif
__inline__ int mknod (__const char *__path, __mode_t __mode,
			     __dev_t __dev) __THROW
{
...
extern
#endif
__inline__ int stat64 (__const char *__path,
...
extern
#endif
__inline__ int lstat64 (__const char *__path,
			       struct stat64 *__statbuf) __THROW
{
...
extern
#endif
__inline__ int fstat64 (int __fd, struct stat64 *__statbuf) __THROW
{
