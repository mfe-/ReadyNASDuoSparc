...
enum {
        ...
        DEV_RAID_SPEED_LIMIT_OPT=3,
        DEV_RAID_SPEED_LIMIT_DMA=4,
        DEV_RAID_SPEED_LIMIT_CNT=5,
        DEV_RAID_SPEED_LIMIT_DBG=6,
        DEV_RAID_SPEED_LIMIT_N_S=7,
        DEV_RAID_SPEED_LIMIT_OLD=8,
        DEV_RAID_SPEED_LIMIT_ADD=9,
        DEV_RAID_SPEED_LIMIT_CHK=10
};
#else
enum {
	DEV_RAID_SPEED_LIMIT_MIN=1,
