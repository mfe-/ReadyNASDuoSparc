...
#ifdef CONFIG_PADRE_16K_PAGE
#error "16K PAGE can not support 8K task size"
#else
...
#define alloc_thread_info(tsk) \
    ((struct thread_info *) __get_free_pages(GFP_KERNEL,THREAD_INFO_ORDER))
#define free_thread_info(ti) free_pages((unsigned long) (ti), THREAD_INFO_ORDER)
