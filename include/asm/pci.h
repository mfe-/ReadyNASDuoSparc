...
#define PCIBIOS_MIN_IO		0x00001000UL
#define PCIBIOS_MIN_MEM		0x10010000UL
...
extern void pci_dma_sync_sg_for_cpu(struct pci_dev *hwdev, struct scatterlist *sg, int nents, int direction);
extern void pci_dma_sync_sg_for_device(struct pci_dev *hwdev, struct scatterlist *sg, int nents, int direction);
